...
Especially Kevin Rudd, Athony Fuller, Invalid, Notex, Sieni, Atampy26 and kercyx for helping me along the way.


Mod description:

HITMAN
Subject 6: Sons of Providence
A mod by Danny Bierek
...
Mods that will be generally needed:
Menu mod to add a Story Campaign (Found in Rocco’s revenge)
...
Initial plan:
New story mode:
One mission on Romania
New starting location:
In the final train car
Scenery changes:
...
Initial plan:
New story mode:
One mission on Siberia Level
New starting location:
In front of the mansion
Scenery changes:
Add a cityscape to make it look more like the Red Square in Moscow
Have restricted loadout:
Sawed-off Shotgun
Tactical Wetsuit
Only one starting location
